...
int main()
{
    ...
    //controls-
    //ccle_colour change-('F1-F9')
    //cycle movements -(rigth arrow, left arrow)
    ...
    int poly_upline=150,poly_lowerline=100,poly_leftline=100,poly_rithline=225;
    int handle_1=150,handle_2=145,handle_3=200;
    ...
    //creating graphics window
        DWORD screendwidth=GetSystemMetrics(SM_CXSCREEN);
        DWORD screendheight=GetSystemMetrics(SM_CYSCREEN);
        initwindow(screendwidth, screendheight, "Rishbah",-3);
        ...
        line(poly_rithline,390,poly_rithline-50,450); //! rigth line of cycle
        ...
        line(poly_rithline-1,390,poly_rithline-50-1,450); //! rigth line of cycle
        ...
        line(poly_rithline-2,390,poly_rithline-50-2,450); //! rigth line of cycle
        ...
        if(n==1)
        {
            ...
            int points[8]={560,595,570,590,590,600,560,595};
            ...
            line(730,595-1,760,595-1);
            int points2[8]={760,595,750,590,750,600,760,560};
            fillpoly(4,points2);
